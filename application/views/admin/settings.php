<?php include 'application/views/inc/header.php'; ?>
                ...
                <section>
                    ...
                    <div class="well well-large">
                        ...
                        <div class="control-group">
                            <?php
                                echo form_label('Year', 'year', array('class' => 'control-label'));
                            ?>
                            <div class="controls">
                                <div class="input-prepend">
                                ...
                                <span class="help-block"><em>Enter the year here for which all accounts will be populated.</em></span>
                            </div>
                        </div>
                        <div class="control-group">
                            <?php
                    ...
                    <div class="well well-large">
                        <?php
                        if ($guest_account_flag)
                            echo anchor('admin/create_guest_account', 'Create Guest Account', array('class' => 'btn btn-success disabled'));
                        else
                            echo anchor('admin/create_guest_account', 'Create Guest Account', array('class' => 'btn btn-success'));
                        ?>
                    </div>
                    <div class="well well-large">
