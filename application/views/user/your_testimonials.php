<?php include 'application/views/inc/header.php'; ?>
                ...
                <section>
                    ...
                    <div class="page-header"><h1><i class="icon-asterisk"></i>&nbsp;Your Testimonials <small>Manage all of them here</small></h1></div>
                    ...
                    <div id="#public">
                        <h2>Your public testimonials</h2>
                    ...
                    <div id="#private">
                        <h2>Your private testimonials</h2>
