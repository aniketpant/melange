<?php include 'application/views/inc/header.php'; ?>
                ...
                <section>
                    ...
                    <div class="page-header"><h1><i class="icon-edit"></i>&nbsp;Profile <small>You can edit your profile here</small></h1></div>
                            ...
                            <div class="controls">
                                <div class="input-xlarge">
                                    <?php
                                        ...
                                        echo form_dropdown('month', $arr_month, $month, 'class = "span2"');
                                    ?>
