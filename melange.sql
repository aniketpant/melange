...
INSERT INTO `testimonials` (`idtestimonials`, `content`, `testimonial_for`, `testimonial_by`, `is_approved`, `is_public`) VALUES
(1, 'Test.', 1, 1, 1, 0),
(2, 'This will be made public.', 1, 1, 1, 1),
(3, 'This will be made private.', 1, 1, 1, 0),
(4, 'Another test.', 1, 1, 1, 1);
...
INSERT INTO `user_details` (`iduser_details`, `user_master_iduser_details`, `id_number`, `name`, `nick`, `dob`, `hostel`, `roomno`, `address`, `contact`, `email`, `image_name`, `image_thumb`, `image_path`) VALUES
(1, 6, '2010A4PS353G', 'Aniket Pant', 'tre4surehunt3r', '15 August 1993', 'AH7', 249, 'ABC\r\nDEF\r\nGHI\r\nJKL', '9637130502', 'borncssed@gmail.com', 'admin.jpg', 'admin_thumb.jpg', 'C:/wamp/www/melange/uploads/');
...
INSERT INTO `user_master` (`iduser_master`, `user_name`, `user_password`, `user_last_login`) VALUES
(6, 'admin', '$2a$08$H/UWvGocwpaq0/.A.Fsle..IzzQmGBFCqPctdiYjWAV1DqcuPylzi', '2012-04-13 20:29:25');
